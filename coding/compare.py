...
def make_plots(
    ...
    title1, _ = _make_title("Cost vs. Accuracy", task, model_name, reward_model_name)
    ...
    title2, _ = _make_title("Per-trial Cost Sorted by SAP", task, model_name, reward_model_name)
    ...
    ax.set_ylabel("Count")
    hist_main, hist_sub = _make_title("ADAP / SAP Cost Ratio", task, model_name, reward_model_name)
...
def main():
    ...
    ap.add_argument("--reward-key", default="r_last", choices=["r_min", "r_mean", "r_last", "r_prod", "r_score"])
